...
public class CodigoBarras {
    ...
    @ApiModelProperty(value = "Quantidade do produto que será movimentada quando este código de barras for utilizado em alguma movimentação. O valor padrão deste campo é 1", position = 4)
